...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=ghcr.io/nethserver/nextsec-vpn:$tag ghcr.io/nethserver/nextsec-api:$tag ghcr.io/nethserver/nextsec-ui:$tag docker.io/library/traefik:v2.6" \
    "${container}"
# Commit the image
